            ...
            if (i.customId == `4`) {
              ...
              i.reply({
                embeds: [new MessageEmbed()
                  .setColor(es.color)
                  .setTimestamp()
                  .setTitle(`${player.get(`autoplay`) ? `<:dinotick:989898287421214721> **Enabled Autoplay**` : `❌ **Disabled Autoplay**`}`)
                  .setFooter(client.getFooter(`💢 Action by: ${member.user.tag}`, member.user.displayAvatarURL({
                    dynamic: true
                  })))
                ]
            ...
            if (i.customId == `6`) {
              ...
              i.reply({
                embeds: [new MessageEmbed()
                  .setColor(es.color)
                  .setTimestamp()
                  .setTitle(`${player.trackRepeat ? `<:dinotick:989898287421214721> **Enabled Song Loop**` : `❌ **Disabled Song Loop**`}`)
                  .setFooter(client.getFooter(`💢 Action by: ${member.user.tag}`, member.user.displayAvatarURL({
                    dynamic: true
                  })))
                ]
            ...
            if (i.customId == `7`) {
              ...
              i.reply({
                embeds: [new MessageEmbed()
                  .setColor(es.color)
                  .setTimestamp()
                  .setTitle(`${player.queueRepeat ? `<:dinotick:989898287421214721> **Enabled Queue Loop**` : `❌ **Disabled Queue Loop**`}`)
                  .setFooter(client.getFooter(`💢 Action by: ${member.user.tag}`, member.user.displayAvatarURL({
                    dynamic: true
                  })))
                ]
...
function generateQueueEmbed(client, player, track) {
  ...
  embed.setAuthor(`Now Playing...`, "https://cdn.discordapp.com/attachments/1041734803239751791/1042391445505577000/emoji.gif")
  embed.setTitle(`${track.title}`)
  embed.setDescription(`Duration: \`[${format(track.duration)}]\``)
  ...
  let skip = new MessageButton().setStyle('PRIMARY').setCustomId('1').setEmoji(`978647552729702441`).setLabel(`Skip`)
  let stop = new MessageButton().setStyle('DANGER').setCustomId('2').setEmoji(`981500247614324806`).setLabel(`Stop`)
  let pause = new MessageButton().setStyle('SECONDARY').setCustomId('3').setEmoji('⏸').setLabel(`Pause`)
  let autoplay = new MessageButton().setStyle('SUCCESS').setCustomId('4').setEmoji('981500699441524736').setLabel(`Autoplay`)

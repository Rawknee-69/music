  ...
  async function song_() {
    ...
    if (player.state !== "CONNECTED") {
      ...
      var playembed = new MessageEmbed()
        ...
        .setColor(ee.color)
        .addField("<a:duration:989901349565132850> Duration: ", `> \`${res.tracks[0].isStream ? "LIVE STREAM" : format(res.tracks[0].duration)}\``, true)
        .addField("<a:Author:996690836353982506> Author: ", `> \`${res.tracks[0].author}\``, true)
        .addField("<:queue:978850428223635496> Queue length: ", `> \`${player.queue.length} Songs\``, true)

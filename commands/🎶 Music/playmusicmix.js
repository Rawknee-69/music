...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    let link = "https://open.spotify.com/playlist/37i9dQZF1E38wJRJ6tsZqL?si=d7bf181f2d204598";
    if (args[0]) {
    ...
    message.reply({
      embeds: [new MessageEmbed()
        .setColor(es.color)
        .setAuthor(client.getAuthor(`Loading '${args[0] ? args[0] : "Default"}' Music Mix`, "https://cdn.discordapp.com/attachments/1041734803239751791/1042391950864683078/emoji.gif", link))
